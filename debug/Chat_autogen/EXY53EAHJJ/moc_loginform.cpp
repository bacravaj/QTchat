...
QT_MOC_LITERAL(1, 10, 21), // "registrationRequested"
...
QT_MOC_LITERAL(7, 67, 21), // "on_buttonBox_accepted"
QT_MOC_LITERAL(8, 89, 21), // "on_buttonBox_rejected"
QT_MOC_LITERAL(9, 111, 33) // "on_registrarionPushButton_cli..."

    },
    "LoginForm\0registrationRequested\0\0"
    "accepted\0userId\0userName\0rejected\0"
    "on_buttonBox_accepted\0on_buttonBox_rejected\0"
    "on_registrarionPushButton_clicked"
};
...
void LoginForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 5: _t->on_registrarionPushButton_clicked(); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&LoginForm::registrationRequested)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void LoginForm::registrationRequested()
{
