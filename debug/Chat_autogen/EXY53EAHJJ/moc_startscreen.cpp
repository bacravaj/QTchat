...
QT_MOC_LITERAL(3, 24, 6), // "UserId"
QT_MOC_LITERAL(4, 31, 8), // "userName"
QT_MOC_LITERAL(5, 40, 17) // "onRejectRequested"

    },
    "StartScreen\0onLoggedIn\0\0UserId\0userName\0"
    "onRejectRequested"
};
...
void StartScreen::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->onLoggedIn((*reinterpret_cast< uint(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
